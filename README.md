# Data Analysis and Visualization with RedHat OpenShift AI

This is the second in a series of 6 courses about Red Hat OpenShift AI (RHOAI).
This courses focuses on using RHOAI to explore, analyze, and visualize data.
...
```
    $ git clone git@github.com:RedHatQuickCourses/rhods-analysis.git
```
...
12. Verify that your changes have been published to the production GitHub pages website at https://redhatquickcourses.github.io/rhods-analysis

## Problems and Feedback
If you run into any issues, report bugs/suggestions/improvements about this course here - https://github.com/RedHatQuickCourses/rhods-analysis/issues
